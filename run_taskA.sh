...
plot_all()
{
    ...
    gnuplot -c $gnu_file "$1/throughput_$2.png" "throughput vs $2" "$2" "throughput" "$3" "$4" 5
    gnuplot -c $gnu_file "$1/delay_$2.png" "delay vs $2" "$2" "delay" "$3" "$4" 6
...
# do
#     ./waf --run "scratch/taskA1.cc --nNodes=${i} --file=${file}" > taskA/logA1.txt 2>&1
#     echo "Node : $i done"
# done
